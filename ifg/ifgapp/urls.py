...
urlpatterns = patterns('',
    ...
    url(r'^metatarefas', 'ifgapp.views.listing_metatarefas', name='lista_metatarefas'),
    ...
    url(r'^metatarefa/(?P<pk>\d+)/$', 'ifgapp.views.edit_metatarefa', name='edit_metatarefa'),
    ...
    url(r'^remover/metatarefa/(?P<pk>\d+)/$', 'ifgapp.views.remover_metatarefa', name='remover_metatarefa'),
    ...
    url(r'^adicionar/metatarefa', 'ifgapp.views.adicionar_metatarefa', name='adicionar_metatarefa'),
